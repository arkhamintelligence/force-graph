...
(function (global, factory) {
  ...
  **/
      ...
      tickFrame: function tickFrame(state) {
        ...
        function paintLinks() {
          ...
          if (state.linkCanvasObject) {
            ...
            defaultPaintLinks = [].concat(_toConsumableArray$1(beforeCustomLinks), afterCustomLinks, otherCustomLinks);
              ...
              Object.entries(linesPerLineDash).forEach(function (_ref5) {
                ...
                links.forEach(function (link) {
                  ...
                  if (!controlPoints) {
                    ...
                    ctx[controlPoints.length === 2 ? 'quadraticCurveTo' : 'bezierCurveTo'].apply(ctx, _toConsumableArray$1(controlPoints).concat([end.x, end.y]));
                  }
                });
        ...
        function paintArrows() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints && _construct(Bezier, [start.x, start.y].concat(_toConsumableArray$1(link.__controlPoints), [end.x, end.y]));
        ...
        function paintPhotons() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints ? _construct(Bezier, [start.x, start.y].concat(_toConsumableArray$1(link.__controlPoints), [end.x, end.y])) : null;
  ...
  var linkedProps = Object.assign.apply(Object, _toConsumableArray$1(['nodeColor', 'nodeAutoColorBy', 'nodeCanvasObject', 'nodeCanvasObjectMode', 'linkColor', 'linkAutoColorBy', 'linkLineDash', 'linkWidth', 'linkCanvasObject', 'linkCanvasObjectMode', 'linkDirectionalArrowLength', 'linkDirectionalArrowColor', 'linkDirectionalArrowRelPos', 'linkDirectionalParticles', 'linkDirectionalParticleSpeed', 'linkDirectionalParticleWidth', 'linkDirectionalParticleColor', 'dagMode', 'dagLevelDistance', 'dagNodeFilter', 'onDagError', 'd3AlphaMin', 'd3AlphaDecay', 'd3VelocityDecay', 'warmupTicks', 'cooldownTicks', 'cooldownTime', 'onEngineTick', 'onEngineStop'].map(function (p) {
    return _defineProperty({}, p, bindFG.linkProp(p));
  })).concat(_toConsumableArray$1(['nodeRelSize', 'nodeId', 'nodeVal', 'nodeVisibility', 'linkSource', 'linkTarget', 'linkVisibility', 'linkCurvature'].map(function (p) {
    return _defineProperty({}, p, bindBoth.linkProp(p));
  }))));
  var linkedMethods = Object.assign.apply(Object, _toConsumableArray$1(['d3Force', 'd3ReheatSimulation', 'emitParticle'].map(function (p) {
